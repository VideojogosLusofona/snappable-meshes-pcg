...
namespace SnapMeshPCG.SelectionMethods
{
    ...
    public sealed class StarSM : AbstractSM
    {
        ...
        /// <summary>
        /// Creates a new star selection method instance.
        /// </summary>
        ...
        /// </param>
        public StarSM(uint armLength, uint armLengthVar)
        {
        ...
        /// <remarks>
        /// For the star selection method, the piece with most connectors is
        ...
        /// </returns>
        /// <remarks>
        /// For the star selection method the starting piece acts as the
