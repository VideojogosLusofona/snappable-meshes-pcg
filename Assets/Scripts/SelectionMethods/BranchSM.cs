...
{
    /// <summary>
    /// The branch selection method creates branches in the same manner as the
    ...
    /// reached.
    /// </summary>
    public sealed class BranchSM : AbstractSM
    {
        ...
        /// <summary>
        /// Creates a new branch selection method instance.
        /// </summary>
        ...
        /// branch.
        /// </param>
        public BranchSM(uint branchCount, uint branchLength, uint branchLengthVar)
        {
        ...
        /// <remarks>
        /// For the branch selection method, the piece with less connectors
        ...
        /// </returns>
        /// <remarks>
        /// For the branch selection method, the next guide piece is returned
