...
namespace SnapMeshPCG.Experiments
{
    ...
    {
        public IDictionary<string, IDictionary<string, IDictionary<string, object>>> Runs =>
            new Dictionary<string, IDictionary<string, IDictionary<string, object>>>()
            {
                ["(a)"] = new Dictionary<string, IDictionary<string, object>>()
                {
                    ["GenerationManager"] = new Dictionary<string, object>()
                    {
                        ["_useSeed"] = true,
                        ["_seed"] = -267402550,
